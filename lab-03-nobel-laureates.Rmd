...
- there are 935 observations and 26 variables in the dataset. each observation represents a different nobel prize won, and each variable represents information about the winner. 
...
3.  Create a faceted bar plot visualizing the relationship between the category of prize and whether the laureate was in the US when they won the nobel prize.
  ...
  coord_flip()
    ...
    #changed fill to category instead of surname
    
    ```
    
    - this chart shows that more nobel prize winners were in the US when they recieved their award than those who were in other countries. Based on the Buzzfeed headline, this data agrees with it that many nobel prize winners are based in the US.
...
nobel_living <- nobel_living %>%
  mutate(born_country_us= if_else(born_country == "USA", "USA", "Other"))
    ...
    ggplot(nobel_living, aes(x = born_country_us, fill = category)) +
  geom_bar() +
  facet_wrap(~category, ncol = 2) +
  coord_flip()
    
    # cannot find out how to find number of US born nobel prize winners
...
- Based on this plot, the buzzfeed article would appear to be incorrect. In the USA category, there is more blue (born in US) than orange (not born in US) for nobel prize winners.
