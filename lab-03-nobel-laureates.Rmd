...
***there are `r nrow(nobel)` observations and `r ncol(nobel)` variables in the dataset. each observation represents a different nobel prize winner, and each variable represents information about the winner.***
...
3.  Create a faceted bar plot visualizing the relationship between the category of prize and whether the laureate was in the US when they won the nobel prize.
    ...
    ggplot(data = nobel_living_science, aes(x = country_us, fill = category)) +
  geom_bar() +
